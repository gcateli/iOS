...
var myPlans = "get out home"
var friendPlans = myPlans


// Update `myPlans` here:

myPlans += " and take a shit"
...
func addDance(_ action: String) -> String{
    return "We like to \(action) and then we dance."
}
...
import Foundation
let rightNow = Date()
let measuredTime = rightNow.timeIntervalSince1970
