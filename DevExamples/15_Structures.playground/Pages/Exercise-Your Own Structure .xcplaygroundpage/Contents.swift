 ...
 */
 ...
 // Type Phone. it has properties like manufacturer, screen size and actions like phone call and save contact
 //
 //
...
struct Phone{
    ...
    func phoneCall(_ contactNumber: String){
 ...
 */
let iPhone = Phone(manufacturer: "Apple", screenSize: 4, dualCamera: true)
let Wander = Contact(name: "Wander", phoneNumber: "99453-4563")
iPhone.phoneCall(Wander.name)
Wander.saveContact(Wander)
