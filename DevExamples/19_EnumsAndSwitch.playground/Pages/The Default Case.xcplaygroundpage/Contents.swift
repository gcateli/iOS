...
//if you have have all the enum cases defined here, there won't be a need for a default value, because it will never be executed
switch quality {
case .bad:
