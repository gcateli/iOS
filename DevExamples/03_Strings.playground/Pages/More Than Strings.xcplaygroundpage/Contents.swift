...
let name = "Guilherme"
let number = 9
let adjective = "fucking"
let noun = "pen"
let place = "shop"
let goodEmotion = "happy"
let badEmotion = "frustrated"
// Add your version of the story below

let sampleStory = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(goodEmotion). But then they felt \(badEmotion). They were all out of \(noun)!"
