 ...
 */
let phoneStorage = 8000
let usedStorage = 3000
let minutesOfVideo = (phoneStorage - usedStorage)/150

let storageWarning = "Total storage: \(phoneStorage/1000) GB\nAvailable storage: \(usedStorage/1000)GB\nYou have \(minutesOfVideo) minutes of video available to record."
