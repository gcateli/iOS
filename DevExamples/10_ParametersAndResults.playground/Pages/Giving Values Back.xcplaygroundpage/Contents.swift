...
func favorite(category: String, thing: String) -> String{
    
    return "My favorite \(category) is \(thing)"
}

print(favorite(category: "band", thing: "Hillsong United"))
print(favorite(category: "singer", thing: "Hozier"))
print(favorite(category: "sound interface", thing: "Scarlett"))
print(favorite(category: "guitar player", thing: "Juninho Afram"))
