...
For example:
*/
func printHelloTo(_ name: String,_ adjective: String) {
    print("Hello " + name + ", you " + adjective)
}
printHelloTo("Maya","bitch")
printHelloTo("Hiro","bastard")
...
printHelloTo("Jack","son of a bitch")
printHelloTo("Guilherme", "heartless prick")
printHelloTo("Wander", "chinese motherfucker")
