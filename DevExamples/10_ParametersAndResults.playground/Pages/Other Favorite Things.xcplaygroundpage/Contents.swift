...
*/
func favorite(category: String, thing: String){
    print("My favorite \(category) is \(thing)")
}

favorite(category: "OS", thing: "MacOS")
favorite(category: "mobile OS", thing: "iOS")
favorite(category: "game console", thing: "PlayStation")
favorite(category: "videogame", thing: "The Last of Us")
favorite(category: "guitar brand", thing: "C.F. Martin")
