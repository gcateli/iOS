...
hello(firstName: "Guilherme", lastName: "Cateli")
hello(firstName: "John", lastName: "Lennon")
hello(firstName: "Darkness", lastName: "my old friend")
hello(firstName: "Luciana", lastName: "Genaro")
